...
def page_2():
    ...
    # Loan Percent Income:
    lpi = st.number_input("Enter the % Income to be used for repaying:", 0, 100)
    ...
    # Display the input data as JSON:
    ...
    if st.button("Predict Credit Score", key=9):
        ...
        out = {1: "The Customer is capable of DEFAULTING. Hence it is RISKY to provide a loan!",
               0: "The Customer is capable of NOT DEFAULTING. Hence it is POSSIBLE to provide a loan!"}
        st.write(f"The Final Verdict obtained from the given model is: {out[res]}")
